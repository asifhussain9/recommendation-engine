...
public interface ProductRepository extends ReactiveMongoRepository<Product, String> {
    ...
    Flux<Product> findBySoldGreaterThanAndStockLessThan(int sold, int stock, Pageable pageable);
    Flux<Product> findByDiscountGreaterThan(double discount, Pageable pageable);
